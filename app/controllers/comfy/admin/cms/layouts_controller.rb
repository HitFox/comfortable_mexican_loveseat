...
protected
  ...
  def build_layout
    ...
    @layout.content     ||= "{{ cms:field:meta_description:string }}\n{{ cms:field:meta_title:string }}\n{{ cms:field:canonical_href:string }}\n{{ cms:field:meta_index:string }}\n{{ cms:field:meta_noindex:string }}\n{{ cms:page:content:rich_text }}"
  end
